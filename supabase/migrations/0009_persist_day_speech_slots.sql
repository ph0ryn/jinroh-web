create or replace function public.app_insert_day_speech_slots(
  p_room_id bigint,
...
drop function if exists public.app_resolve_phase(
  bigint,
  text,
  uuid,
  integer,
...
revoke all on function public.app_insert_day_speech_slots(bigint, uuid, jsonb)
...
grant execute on function public.app_insert_day_speech_slots(bigint, uuid, jsonb)
  to service_role;
