export const enLocalization = {
  ...
  home: {
    ...
    scenarios: {
      ...
      waiting: {
        notice:
          "Room lobbies expire on a deadline before or between games. Host controls stay server-authorized.",
        primaryAction: "Start game",
        secondaryAction: "Copy room code",
        summary:
          "Hosts can confirm players, tune the rule set, and start when everyone is present and ready.",
        title: "Waiting",
      },
      night: {
        notice:
