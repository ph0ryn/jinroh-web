...
export const jaLocalization = {
  ...
  home: {
    ...
    scenarios: {
      ...
      waiting: {
        notice:
          "ゲーム前とゲーム間のロビーには期限があります。ホスト操作はサーバーで認可されます。",
        primaryAction: "ゲーム開始",
        secondaryAction: "部屋コードをコピー",
        summary: "ホストは参加者確認、ルール調整、全員が参加・準備完了した時点での開始ができます。",
        title: "待機中",
      },
      night: {
  ...
  live: {
    ...
    hints: {
      ...
      readyToStart: "全員が準備完了しました。ゲームを開始できます。",
      startAfterSync: "更新が終わると開始できます。",
      startOutsideLobby: "ゲーム開始はプレイ前または結果画面から行えます。",
      startNeedsRoom: "開始する前に部屋を作成または参加してください。",
      tooManyPlayers: "参加人数が選択した定員を超えています。",
      waitingForConnections: (count: number) => `開始するには${count}人の再接続が必要です。`,
      waitingForHostStart: "全員が準備完了しました。ホストの開始を待っています。",
      waitingForPlayers: (count: number) => `開始にはあと${count}人必要です。`,
      waitingForReadiness: (count: number) => `まだ${count}人が準備完了していません。`,
    },
    invite: {
    ...
    waiting: {
      ...
      prepareNextGame: "次のゲームを準備",
      prepareToPlay: "ゲームの準備",
    ...
    room: {
      ...
      closed: "その部屋は閉じられているため、参加できません。",
      full: "参加先の部屋は満席です。現在の部屋にはそのまま残っています。",
      gameChanged: "ゲームが切り替わりました。最新の部屋状態を確認してもう一度お試しください。",
      ...
      playersNotReady: "ゲーム開始には、接続中の全員が準備完了する必要があります。",
      readyToJoin: "部屋に参加できます。",
      rosterChanged: "参加者が変わりました。準備状態を確認してもう一度お試しください。",
